...
//        MypMasterViewController *masterViewController = [[MypMasterViewController alloc] initWithNibName:@"JViewController" bundle:nil];
        ...
        MypDetailViewController *detailViewController = [[MypDetailViewController alloc] initWithNibName:@"MypDetailViewController_iPad" bundle:nil];
